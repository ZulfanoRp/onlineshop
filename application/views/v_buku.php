...
<table class="table table-hover table-stripped">
	...
	<thead>
		...
		<tr>
			...
			<td>no</td><td>kode_hp</td><td>tipe_hp</td><td>tahun</td><td>kategori</td><td>harga</td><td>layar</td><td>merk</td><td>stok</td><td></td><td></td>
	...
	<tbody>
		...
		<tr>
			...
			<td><?=$no?></td><td><?=$bk->kode_buku?></td><td><?=$bk->judul_buku?></td><td><?=$bk->tahun?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><img src="<?=base_url('assets/gambar/'.$bk->cover)?>" style="width:40px;"></td><td><?=$bk->penerbit?></td><td><?=$bk->stok?></td>
