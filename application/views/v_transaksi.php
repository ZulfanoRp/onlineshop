	...
	<div class="col-md-7">
		...
		<table class="table table-hover table-stripped">
			...
			<thead>
				...
				<td>no</td><td>tipe_hp</td><td>tahun</td><td>kategori</td><td>harga</td><td>layar</td><td>merk</td><td>stok</td><td></td><td></td>
			...
			<tbody>
				...
				<tr>
					...
					<td><?=$no?></td></td><td><?=$bk->judul_buku?></td><td><?=$bk->tahun?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><img src="<?=base_url('assets/gambar/'.$bk->cover)?>" style="width:40px;"></td><td><?=$bk->penerbit?></td><td><?=$bk->stok?></td>
...
<table class="table table-stripped table-hover">
	...
	<tr><td colspan="2">Nama Pembeli</td><td colspan="4"><input type="text" name="pembeli" value="<?=$this->session->flashdata('pembeli');?>"></td></tr>
				...
				<th>No</th><th>tipe hp</th><th>Jumlah</th><th>Harga</th><th>Subtotal</th><th></th>
